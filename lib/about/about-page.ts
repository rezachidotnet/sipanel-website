...
const aboutCopy: Record<Locale, Omit<AboutLocaleContent, 'companyStory' | 'executionApproach' | 'leadership'>> = {
  ...
  ar: {
    seo: {
      title: 'حول SIPANEL | خبرة هندسية في أغلفة المباني الصناعية',
      metaDescription:
        'تعرف على خلفية SIPANEL وخبرتها في تصميم وتوريد وتنفيذ أغلفة المباني الصناعية، من رسومات الشوب وضبط المواد إلى العزل المائي والتركيب المنضبط.',
      h1: 'خبرة هندسية في أغلفة المباني الصناعية وتنفيذها المنضبط.'
    },
    hero: {
      eyebrow: 'حول SIPANEL',
      h1: 'خبرة هندسية في أغلفة المباني الصناعية وتنفيذها المنضبط.',
      subheadline:
        'تجمع SIPANEL بين خبرة تنفيذ القاعات الصناعية، وإعداد رسومات الشوب، ومعرفة المواد، وضبط التركيب لتقليل مخاطر التسرب، وهدر المواد، وأخطاء التنسيق في مشاريع الغلاف الصناعي.',
...
const companyStory = {
  ...
  ar: {
    ...
    paragraphs: [
      ...
      'تتعامل SIPANEL مع غلاف المبنى الصناعي باعتباره قراراً هندسياً يبدأ قبل شراء المواد. لذلك يتم فحص وظيفة المبنى، وهندسة السقف، ومسارات تصريف المياه، ومواقع الفتحات، وتفاصيل الفلاشينغ، ونقاط التقاء السقف والواجهة قبل تثبيت نظام الغلاف النهائي.',
      'الخبرة الفنية في التصميم واستخراج الكميات وإعداد رسومات الشوب، إلى جانب المشاركة في مشاريع ذات تصاميم واستخدامات متنوعة، منحت الفريق قدرة عملية على تصميم وتنفيذ أنظمة ألواح الساندويش، وأسقف standing seam وZIP، وكسوة الألمنيوم، وأنظمة الزجاج والبولي كربونات.',
      'يعتمد ضبط التوريد على مطابقة السماكات والألوان والأبعاد والملحقات والبراغي والفلاشينغ مع رسومات الشوب وتسلسل التنفيذ. هذا الأسلوب يقلل الهدر، ويحد من إعادة الطلب، ويمنع وصول مواد غير متوافقة مع تفاصيل العزل المائي أو قدرة فرق التركيب في الموقع.',
      'في مرحلة التنفيذ، تركز SIPANEL على تسلسل التركيب، ومحاذاة الألواح، واستمرارية العزل المائي، وتنسيق المزاريب والمصارف، وفحص نقاط الاختراق والانتقالات. الهدف هو تحويل تفاصيل الغلاف إلى عمل قابل للفحص والتسليم والصيانة، وليس الاكتفاء بتوريد مادة منفصلة عن ظروف المشروع.',
      'تنفيذ مئات المشاريع الصناعية في مختلف أنحاء إيران والدول المجاورة وتحت ظروف مناخية متنوعة وفر خبرة مباشرة في البحور الطويلة، والواجهات المنحنية، والبيئات الساحلية، والمشاريع ذات الجداول الزمنية المضغوطة. تستند SIPANEL إلى الخبرة الهندسية لشركة Fazasazeh Naghsh-e-Jahan وتدير عملياتها الدولية من خلال Global Innovative Co.',
      'تشمل خبرة المشاريع الموثقة مستشفى عسكرياً بسعة 32 سريراً تم تسليمه في أقل من 50 يوماً، ومحطة مطار بمساحة 5,000 m² اكتملت في أقل من سبعة أيام، وسقوفاً طويلة البحر بمساحات تصل إلى 12,000 m2، إضافة إلى واجهات زجاجية وكسوات ألمنيوم ونورگیرات بولي كربونات ذات تفاصيل تنفيذية دقيقة.'
    ],
    points: [
      {
        title: 'الجذور التنفيذية',
        description: 'تأسست سيان صنعت إيرانيان بالاعتماد على خبرة فريق إدارة Fazasazeh Naghsh-e-Jahan في تنفيذ القاعات الصناعية والهياكل الفراغية.'
      },
      {
        title: 'التصميم ورسومات الشوب',
        description: 'تبدأ قرارات الغلاف من مراجعة الرسومات، واستخراج الكميات، وتفاصيل التصريف والفلاشينغ، ثم تحويلها إلى مسار توريد وتركيب قابل للتنفيذ.'
      },
      {
        title: 'ضبط المواد والتوريد',
        description: 'التعاون المستمر مع المصنعين المحليين والدوليين يساعد في اختيار نظام الغلاف المناسب ومطابقة المواد والملحقات مع متطلبات كل مشروع.'
      },
      {
        title: 'التركيب وضبط الجودة',
        description: 'يتم التحكم في تسلسل التركيب، واستمرارية العزل المائي، ومحاذاة الألواح، وفحص نقاط الخطر قبل التسليم للحد من أخطاء التنفيذ.'
      }
    ],
    heritageItems: [
      {
