...
const resourceDetailContent: Record<string, Record<Locale, ResourceDetailContent>> = {
  ...
  sandwich_panel_selection_guide: {
    ...
    fa: {
      title: 'راهنمای خرید و انتخاب ساندویچ پانل',
      summary: 'راهنمای خرید و تصمیم\u200cگیری برای انتخاب نوع پانل، جنس هسته، ضخامت، منطق اتصال، سطح عایق\u200cکاری و ورودی\u200cهای خرید پیش از سفارش.',
      seoDescription: 'راهنمای خرید و انتخاب ساندویچ پانل صنعتی شامل نوع هسته، ضخامت، عایق\u200cکاری، اتصال، شرایط اقلیمی و آمادگی خرید پیش از سفارش.',
      ...
      keyPoints: [
        ...
        {title: 'انتخاب پانل سقفی یا دیواری', description: 'کاربرد سقف یا دیوار، بار برف و باد، شیب و طول دهانه روی ضخامت، نوع درز و اتصال مناسب پانل اثر می‌گذارد.'},
        {title: 'ضخامت و ابعاد', description: 'ضخامت هسته باید با نیاز عایق حرارتی و دهانه سازه هماهنگ باشد؛ ابعاد و طول ورق نیز باید با محدودیت حمل و نصب سایت بررسی شود.'},
